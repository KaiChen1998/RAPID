...
class RLHFDataset(Dataset):
        ...
        if self.filter_overlong_prompts:
            ...
            if processor is not None:
                ...
                def doc2len(doc) -> int:
                    ...
                    images = [process_image(image) for image in doc.pop(self.image_key)]
                    raw_prompt=raw_prompt.replace("<image>", "<IMG_CONTEXT>")
    ...
    def __getitem__(self, item):
        ...
        if self.image_key in row_dict:  # process multimodal data
            ...
            if self.processor.__class__.__name__ == "InternVLProcessor":
                ...
                model_inputs = self.processor(text=[raw_prompt_convert], images=images, return_tensors="pt")
            else:
